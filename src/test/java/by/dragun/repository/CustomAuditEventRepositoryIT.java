package by.dragun.repository;

import by.dragun.JhipsterProjectApp;

import by.dragun.config.Constants;
import by.dragun.config.audit.AuditEventConverter;
import by.dragun.domain.PersistentAuditEvent;
...
import static by.dragun.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
